...
const fr: Dict = {
  ...
  askAccess: "📩 Demander un accès (employés Microsoft)",
  accessTitle: "Demander un accès",
  accessHint: "Réservé aux employés Microsoft. Indiquez votre adresse email, Marc reviendra vers vous.",
  accessEmailPlaceholder: "Votre adresse email Microsoft",
  accessMsgPlaceholder: "Message (optionnel)",
  sendRequest: "Envoyer la demande",
  cancel: "Annuler",
  accessSending: "Envoi en cours...",
  accessSentTitle: "✅ Demande envoyée",
  accessSentMsg: "Merci ! Ta demande a été transmise à Marc pour approbation. Tu recevras une invitation par email une fois validée.",
  accessEmailRequired: "Veuillez saisir une adresse email valide.",
  accessMailSubject: "World Cup Top Scorer — Demande d'accès",
  accessMailIntro: "Bonjour Marc, je souhaite accéder à l'application World Cup Top Scorer.",
  accessMailEmailLabel: "Mon adresse email",
  accessMailMsgLabel: "Message",
...
const en: Dict = {
  ...
  askAccess: "📩 Ask access (Microsoft employees)",
  accessTitle: "Request access",
  accessHint: "For Microsoft employees only. Enter your email and Marc will get back to you.",
  accessEmailPlaceholder: "Your Microsoft email address",
  accessMsgPlaceholder: "Message (optional)",
  sendRequest: "Send request",
  cancel: "Cancel",
  accessSending: "Sending...",
  accessSentTitle: "✅ Request sent",
  accessSentMsg: "Thanks! Your request has been sent to Marc for approval. You'll receive an email invitation once it's approved.",
  accessEmailRequired: "Please enter a valid email address.",
  accessMailSubject: "World Cup Top Scorer — Access request",
  accessMailIntro: "Hi Marc, I would like to get access to the World Cup Top Scorer app.",
  accessMailEmailLabel: "My email address",
  accessMailMsgLabel: "Message",
